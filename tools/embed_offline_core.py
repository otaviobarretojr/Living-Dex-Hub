...
# Each builder/enricher preserves an already generated local asset when its
# public source is temporarily unavailable, so release validation remains safe.
for script in ('build_letsgo_encounters.py','build_swsh_encounters.py','enrich_swsh_dlc_scopes.py','enrich_swsh_special_routes.py','enrich_swsh_outside_dex.py','enrich_swsh_regional_forms.py','enrich_swsh_dlc_encounters.py','build_bdsp_encounters.py','enrich_bdsp_pkhex_routes.py','build_pla_encounters.py'):
