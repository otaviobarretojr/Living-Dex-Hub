/* Living Dex Hub — F7.0 generic acquisition provider registry */
(()=>{'use strict';
...
window.ld8AcquisitionProviders={register,unregister,provider,get,list,currentGameId,resolveForPokemon,ensureBuiltins,audit:()=>{ensureBuiltins();return{version:'8.0-f7.0',genericRegistry:true,providerCount:providers.size,providers:[...providers.keys()],letsGoAdapter:providers.has('letsgo'),swordShieldAdapter:providers.has('swsh'),multiGameReady:true}}};
