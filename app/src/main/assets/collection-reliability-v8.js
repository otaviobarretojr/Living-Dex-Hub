...
/* F11.0 loader — Living Dex + multi-game acquisition guidance + provider-backed availability. */
(()=>{'use strict';
...
function load(){if(typeof document?.createElement!=='function'||!document.head||!document.body)return false;style('livingdex-global-v8.css','livingdex-global');style('livingdex-encounters-v8.css','livingdex-encounters');style('swsh-dex-scope-ui-v8.css','swsh-dex-scopes');script('letsgo-encounters-v8.js','letsgo-data');script('swsh-encounters-v8.js','swsh-data');script('bdsp-encounters-v8.js','bdsp-data');script('pla-encounters-v8.js','pla-data');script('sv-encounters-v8.js','sv-data');script('za-encounters-v8.js','za-data');script('acquisition-provider-registry-v8.js','acquisition-registry');script('acquisition-availability-bridge-v8.js','acquisition-availability-bridge');script('livingdex-global-v8.js','livingdex-global');script('livingdex-encounter-guide-v8.js','encounter-guide');script('swsh-dex-scope-ui-v8.js','swsh-dex-scope-ui');return true}
